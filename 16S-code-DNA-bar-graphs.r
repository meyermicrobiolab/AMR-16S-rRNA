...
colors = c("antiquewhite3","coral1","darkolivegreen2","cornflowerblue","darkgoldenrod1","aquamarine3","darkmagenta","darkslategray","darkslateblue")
...
ggsave("top-phyla-bar-graph-by-treatment-DNA.tiff", units="in", width=8, height=4, dpi=300, compression = 'lzw')
...
ggsave("top-classes-bar-graph-by-treatment-DNA.tiff", units="in", width=8, height=4, dpi=300, compression = 'lzw')
...
ggsave("top-orders-bar-graph-by-treatment-DNA-9by5.tiff", units="in", width=9, height=5, dpi=300, compression = 'lzw')
