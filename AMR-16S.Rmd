...
# melt the phyloseq object so that it is now a dataframe
datm <- psmelt(psnb_fam) 
# cast the new dataframe with columns to keep
OTUdf <- reshape2::dcast(datm, Sample ~ Family, value.var = 'Abundance', fun.aggregate = sum) 
