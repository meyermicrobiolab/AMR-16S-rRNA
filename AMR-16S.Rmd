...
cols<-c("untreated"="#6CD5D9","antibiotic"="#107A86")
...
# add more options - see ancombc2 tutorial in bioconductor
out = ancombc2(data = ps, assay_name = "counts", tax_level = "Genus",
               fix_formula = "type",
               rand_formula = NULL,
               p_adj_method = "BH")
...
res = out$res
out$res 
write.table(res,file="ancomBC-results-BH-genus-by-treatment.txt")
